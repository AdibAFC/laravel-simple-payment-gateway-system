...
<head>
  ...
  <title>Admin Register • PayGate</title>
  <style>
    :root{ --bg:#0e4a3b; --card:#fff; --ink:#0e4a3b; --muted:#6b7280; }
    *{ box-sizing:border-box }
    body{ margin:0; min-height:100vh; display:grid; place-items:center; background:var(--bg);
          font-family:ui-sans-serif,system-ui,Segoe UI,Roboto,Helvetica,Arial; color:#111827 }
    .card{ width:100%; max-width:460px; background:var(--card); border-radius:14px;
    ...
    .btn{ margin-top:16px; width:100%; border:none; border-radius:10px; padding:12px 16px;
          background:#0e4a3b; color:#fff; font-weight:700; }
    .btn:hover{ opacity:.96 }
    .muted{ margin-top:12px; text-align:center; color:var(--muted); font-size:14px }
    a{ color:#0e4a3b; text-decoration:none; font-weight:600 }
